...
public class Fixture
{
                    ...
                    Object oObject)
    {
        ...
        Library.Log("Visualizing fixture");
        //Library.oViewer().Add(oObject.VoxObject(),0);
        Library.oViewer().Add(voxFixture, 1);

        Library.oViewer().SetGroupMaterial(0, "00FF00AA", 0.5f, 0.5f);
        Library.oViewer().SetGroupMaterial(1, "FF0000", 0.5f, 0.5f);
        Library.oViewer().SetGroupMaterial(2, "0000FFAA", 0.5f, 0.5f);
